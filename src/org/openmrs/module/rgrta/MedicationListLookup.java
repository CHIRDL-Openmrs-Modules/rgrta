...
import org.openmrs.module.rgrta.advice.QueryMeds;
import org.openmrs.module.rgrta.xmlBeans.UnfilteredMedications;
...
public class MedicationListLookup {
	...
	public static void queryMedicationList(Encounter encounter, boolean useTimeout) throws QueryMedicationListException {
		...
		try {
			if (useTimeout) {
				timeout = Integer.parseInt(adminService.getGlobalProperty("Rgrta.medicationListTimeout"));
	...
	public static void filterMedListByDate(LinkedList<Medication> medicationList, 
		...
		HashMap<String,org.openmrs.module.rgrta.xmlBeans.Medication> exceptionMeds = null;
		...
		if (medExceptionConfigFilename != null) {
			try {
				...
				try {
					...
					exceptionMeds = new HashMap<String, org.openmrs.module.rgrta.xmlBeans.Medication>();
					
					for (org.openmrs.module.rgrta.xmlBeans.Medication medication : unfilteredMedications
		...
		if (exceptionMeds != null) {
			while (iter.hasNext()) {
				...
				org.openmrs.module.rgrta.xmlBeans.Medication unfilteredMed = exceptionMeds.get(currMed.getNdcName());
