 ...
 *
 */
public class RgrtaActivator implements Activator {
	 ...
	 */
	public void startup() {
		this.log.info("Starting RGRTA Module");
	...
	private void checkGlobalProperties()
	{
		...
		{
			this.log.error("Error checking global properties for Rgrta module");
	...
	public void shutdown() {
		this.log.info("Shutting down Rgrta Module");
	}
