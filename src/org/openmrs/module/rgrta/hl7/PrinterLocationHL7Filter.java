...
public class PrinterLocationHL7Filter implements HL7Filter
{
			...
			Message message,String incomingMessageString)
	{
		...
		if (hl7EncounterHandler instanceof org.openmrs.module.rgrta.hl7.sms.HL7EncounterHandler25)
		{

			printerLocation = ((org.openmrs.module.rgrta.hl7.sms.HL7EncounterHandler25) hl7EncounterHandler)
					.getPrinterLocation(message,incomingMessageString);
			locationString = ((org.openmrs.module.rgrta.hl7.sms.HL7EncounterHandler25) hl7EncounterHandler)
					.getLocation(message);
		}
