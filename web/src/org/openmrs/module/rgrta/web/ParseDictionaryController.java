...
import org.openmrs.module.rgrta.xmlBeans.FindObsvTerm;
import org.openmrs.module.rgrta.xmlBeans.ObsvDictionary;
...
public class ParseDictionaryController extends SimpleFormController
{
	...
	private ConceptClass getConceptClass(String type){
		...
		if(conceptClass == null){
			conceptClass = conceptService.getConceptClassByName("Rgrta");
		}
		return conceptClass;
	}
}
