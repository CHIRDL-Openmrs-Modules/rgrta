...
import org.openmrs.module.rgrta.hl7.sms.HL7EncounterHandler25;
import org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25;
import org.openmrs.module.rgrta.hl7.sms.HL7SocketHandler;
import org.openmrs.module.rgrta.hl7.sms.PatientHandler;
...
public class ManualCheckinController extends SimpleFormController
{
	...
	protected Map referenceData(HttpServletRequest request) throws Exception
	{
		...
		List<String> stationNames =  RgrtaService.getPrinterStations(location);
		...
		List<String> categories = RgrtaService.getInsCategories();
	...
	private void checkin(HttpServletRequest request,Map<String, Object> map,
		...
		//create encounter
		org.openmrs.module.rgrta.hibernateBeans.Encounter newEncounter = new org.openmrs.module.rgrta.hibernateBeans.Encounter();
