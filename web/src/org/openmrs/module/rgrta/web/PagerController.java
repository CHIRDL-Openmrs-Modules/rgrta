...
public class PagerController extends SimpleFormController
{
	...
	protected Map referenceData(HttpServletRequest request) throws Exception {
		...
		if (sendPage != null) {
			...
			String pagerNumber = adminService.getGlobalProperty("Rgrta.pagerNumber");
			
			String idParam = adminService.getGlobalProperty("Rgrta.pagerUrlNumberParam");
			String textParam = adminService.getGlobalProperty("Rgrta.pagerUrlMessageParam");
			String baseUrl = adminService.getGlobalProperty("Rgrta.pagerBaseURL");
			String thresholdTime = adminService.getGlobalProperty("Rgrta.pagerWaitTimeBeforeRepage");
			...
			String QryStrId, String QryStrText, String thresholdTime,Integer locationId)
	{
		...
		if(goAhead == false)
		{
			...
			+"Rgrta Support will contact you shortly.";
