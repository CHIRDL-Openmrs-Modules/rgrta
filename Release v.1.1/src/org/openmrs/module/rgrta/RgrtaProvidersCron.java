...
public class RgrtaProvidersCron extends AbstractTask
{
	...
	public void execute()
	{
		...
		try
		{
			...
			log.info("Rgrta Providers were retired last on: " + lastRunDate.toString());
	...
	private void init()
	{
		...
		try
		{
			...
			retireProvidersPriorToDays = -Integer.parseInt(adminService.getGlobalProperty("Rgrta.retireProvidersPeriod"));  // in days
