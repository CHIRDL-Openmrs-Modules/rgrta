...
public class PatientHandler extends org.openmrs.module.sockethl7listener.PatientHandler
{
			...
			Location sendingFacility, HL7PatientHandler hl7PatientHandler)
	{
		...
		if (hl7PatientHandler instanceof org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25)
		{
			// patient ssn 
			String ssn = ((org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25) hl7PatientHandler)
					.getSSN(message);
			...
			// patient religion
			String religion = ((org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25) hl7PatientHandler)
					.getReligion(message);
			if (religion != null)
			{
			...
			String marital = ((org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25) hl7PatientHandler)
			...
			String maiden = ((org.openmrs.module.rgrta.hl7.sms.HL7PatientHandler25) hl7PatientHandler)
