package org.openmrs.module.rgrta.nonInMemoryTests;
...
public class ParseTableToMLM extends BaseModuleContextSensitiveTest {
	...
	{
		String baseDirectory = "C:\\Documents and Settings\\tmdugan\\workspace\\Rgrta\\ruleLibrary\\test\\";
		RgrtaService RgrtaService = Context
				.getService(RgrtaService.class);
		List<OldRule> rules = RgrtaService.getAllOldRules();
